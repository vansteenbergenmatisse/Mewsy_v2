...
| Skipping Revenue Entries — Allows exclusion of specific revenue transactions (by accounting category) from being transferred to the accounting platform. | Supported (Only in Bills repo) | Supported (Only in Bills repo) | Supported (Only in Bills repo) |
| Skipping Payment Entries — Allows exclusion of specific payment transactions (by accounting category) from being transferred to the accounting platform. | Supported (Only in Bills repo) | Supported (Only in Bills repo) | Supported (Only in Bills repo) |
