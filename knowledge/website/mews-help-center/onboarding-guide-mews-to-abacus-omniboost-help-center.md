...
This article provides details on the MEWS PMS to Abacus accounting integration. The accounting integration transfers data from MEWS to Abacus via XML export files.
...
**PART 4**: (Accounting) information necessary to build the MEWS to Abacus integration

**PART 5**: Reconciliation of XML export files

**PART 6**: Other features and configurable items

# PART 1: General setup process of the integration

The start-to-end process of the MEWS to Abacus accounting integration goes as follows:

1.1 **Request the Abacus integration from the MEWS Marketplace**
...
Once there is accounting data available in the MEWS Accounting report, the integration is able to generate a test export file(s). These test XML export files will be sent over to you by email and can be verified by your accounting department. **The file format is perfectly suited for an import into Abacus.**

1.7 **Integration to be activated by Omniboost (XML export files will be sent over automatically to your accounting department)**
...
Before Omniboost can build the MEWS to Abacus accounting integration, you need to specify your preferred accounting flow. Please see PART 2 of this article (https://help.omniboost.io/en/articles/6585772-accounting-setup-in-mews-pms-and-omniboost-accounting-flows) named 'Supported Accounting Flows' and let us know which accounting flow you prefer.

# PART 3: Finish your MEWS (accounting) setup

Before Omniboost can test the MEWS to Abacus accounting integration, you need to specify finish your MEWS (accounting) setup. Please see PART 1 of this article (https://help.omniboost.io/en/articles/6585772-accounting-setup-in-mews-pms-and-omniboost-accounting-flows) named 'MEWS Accounting setup'.

# PART 4: Necessary (Accounting) information

In order to correctly transfer the accounting data from MEWS to Abacus, several pieces of accounting information are required. Please find those items below and provide them to your Omniboost contact person.

**4.1 Do you prefer a Closed or Consumed accounting flow?**

Please see PART 2 of this article.

Please note that the current accounting connection with Abacus can offer a consumed accounting flow and a closed accounting flow based on journal entries.
...
**4.3 Please provide us VAT codes (one VAT code for each VAT percentage)**

In order to transfer VAT amounts from MEWS into Abacus, Omniboost has built a VAT mapping into the accounting connection. Providing Omniboost with an Abacus VAT code for each VAT percentage is sufficient for a correct transfer of VAT amounts.

**4.4 Please provide us a Fallback ledger account for revenues.**
...
**4.5 Please provide us a Fallback ledger account for payments.**
...
**4.8 Do you prefer daily, weekly, or monthly export files?**

The Omniboost accounting connection is able to generate a daily, weekly, or monthly XML file. Please let your Omniboost representative know which file frequency your accounting team prefers.

**4.9 Please provide us the email address(es) to which we should send the export files.**
...
# PART 5: Reconciliation of XML Export file data with MEWS PMS data

**Reconciling the Journal entry XML file**
...
In case you are not sure about the contents of any of the columns in the export file, please reach out to [support@omniboost.io](mailto:support@omniboost.io).

# PART 6: Other features and configurable items of the accounting integration

Please find below an overview of configurable items and features that the MEWS to Abacus integration can support. In case you would like to use any of these features, please reach out to you Omniboost contact or [support@omniboost.io](mailto:support@omniboost.io) in general.
...
By default, the prefix of the journal entry XML file name is the name of your property. For example, in case your hotel is named 'Hotel Omniboost', then the filename prefix would be 'hotel-omniboost'.

Please reach out to you Omniboost contact person in case you would like to change the file name.

## Features

**1. Sending over credit card commission fees separately to Abacus**
...
**2. Skipping revenues and/or payments in the Abacus export files**
