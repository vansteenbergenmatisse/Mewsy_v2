...
Please find below an overview of configurable items and features that the MEWS to Netsuite integration can support. In case you would like to use any of these features, please reach out to you Omniboost contact or [support@omniboost.io](mailto:support@omniboost.io) in general.

## Configurable variables

**1. The name of the Journal Entry sent over to Netsuite**

Please reach out to you Omniboost contact person in case you would like to change the daily journal entry name that arrives in your Netsuite environment.
