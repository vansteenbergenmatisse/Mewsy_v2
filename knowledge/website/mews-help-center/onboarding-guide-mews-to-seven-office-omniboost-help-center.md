...
This article provides details on the MEWS PMS to 24 Seven Office accounting integration. The accounting integration transfers data from MEWS to 24 Seven Office via an API-connection.
...
**PART 4**: (Accounting) information necessary to build the MEWS to 24 Seven Office integration
...
The start-to-end process of the MEWS to 24 Seven Office accounting integration goes as follows:

1.1 **Request the 24 Seven Office integration from the MEWS Marketplace**
...
1.6 **Omniboost to send test entries to your 24 Seven Office environment and verification of test entries by your accounting department**

Once there is accounting data available in the MEWS Accounting report, the integration is able to send over test accounting entries to your 24 Seven Office environment.
...
Once your accounting department has verified the test entries and these are correct, your Omniboost contact person can activate the accounting integration. This means that the integration will fully automatically send over the accounting data to your 24 Seven Office environment on a daily basis.
...
The days-delay with which the accounting integration will send over data from MEWS to your 24 Seven Office environment, will depend on the Accounting Editable History Window settings in MEWS. Please see this article (https://help.omniboost.io/en/articles/6593276-understanding-the-dynamics-between-the-mews-accounting-editable-history-window-and-data-transfer-delay-of-omniboost-accounting-integrations) for a more detailed explanation.

# PART 2: Determining the preferred accounting flow: Closed flow or Consumed flow

Before Omniboost can build the MEWS to 24 Seven Office accounting integration, you need to specify your preferred accounting flow. Please see PART 2 of this article (https://help.omniboost.io/en/articles/6585772-accounting-setup-in-mews-pms-and-omniboost-accounting-flows) named 'Supported Accounting Flows' and let us know which accounting flow you prefer.

Please note that it is possible that according to existing Accounting laws in your country, just one of the Accounting flows is supported by law (either closed or consumed).

# PART 3: Finish your MEWS (accounting) setup

Before Omniboost can test the MEWS to 24 Seven Office accounting integration, you need to specify finish your MEWS (accounting) setup. Please see PART 1 of this article (https://help.omniboost.io/en/articles/6585772-accounting-setup-in-mews-pms-and-omniboost-accounting-flows) named 'MEWS Accounting setup'.

# PART 4: Necessary (Accounting) information

In order to correctly transfer the accounting data from MEWS to 24 Seven Office, several pieces of accounting information are required. Please find those items below and provide them to your Omniboost contact person.
...
Accounts Receivable information consists of invoices and the information of the corresponding debtor accounts. The integration is able to send over invoices to 24 Seven Office via two ways:

- As sales entries (including debtor information)
- As part of general journal entries

**By default, invoices are sent over to 24 Seven Office as sales entries.** In case you prefer invoice amounts to be sent over as part of the general journal entries, please reach out to your Omniboost contact person.

**4.4 Please provide your 24 Seven Office Identity Name**

The MEWS PMS to 24 Seven Office accounting integration is based on an API-connection which means that accounting data can be automatically pushed into your 24 Seven Office environment. **Please note that** all entries which are pushed into your 24 Seven Office environment, are **draft** entries. This means that you are always able to modify or remove these entries in case this is necessary.

In order to establish this API-connection, your Omniboost contact person will reach out to you with the request to provide your 24 Seven Office Identity Name. The Identity Name is equal to the name of your property in the 24 Seven Office accounting environment.

**Please note that providing your 24 Seven Office Identity Name** only enables the Omniboost accounting integration to push data into your 24 Seven Office environment. It does **not** give anyone from Omniboost access to the environment itself.
...
Please note that these VAT codes should **not** be created in your MEWS environment.

**4.6 Please let us know how many digits debtor numbers should be**

In case you want the integration to send over Accounts Receivable information to 24 Seven Office (i.e. invoices along with debtor information), we can let the accounting integration generate debtor numbers.
...
Please note that the MEWS _Accounting_ _report_ shows revenues (and payments) based on an accounting category level.
...
**1. The name of the Journal Entry sent over to 24 Seven Office**

Please reach out to you Omniboost contact person in case you would like to change the daily journal entry name that arrives in your 24 Seven Office environment.

## Features

**1. Sending over credit card commission fees separately to 24 Seven Office**
...
In case the default currency in your MEWS PMS environment differs from the default currency in your 24 Seven Office environment, please let us know. We can apply a currency conversation rate in the accounting integration. Please note that this is a fixed rate conversation and not a real-time one.