...
3. **Never changes the real content** — word-for-word preservation of titles, steps, instructions, and body text is critical. If Mewsy tells a user the wrong steps because the AI paraphrased something, that's a bug.
...
Reads and writes `knowledge/knowledge-manifest.json`. This file is the index of everything Mewsy knows about.
