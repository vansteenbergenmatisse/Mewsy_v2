      ...
      {widgetMode === 'fullscreen' && (
        <div id="sidebar" className={sidebarCollapsed ? '' : 'expanded'}>
          ...
          <div className="sidebar-header">
            ...
            <button className="sidebar-toggle-btn" onClick={onToggleSidebar} title={s('shrinkToPanel')}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          {/* Nav items */}
          <button className="sidebar-row sidebar-row--new" onClick={onNewChat} title={s('newChat')}>
          ...
          <button className="sidebar-row" onClick={onOpenHelp} title={s('helpResources')}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
