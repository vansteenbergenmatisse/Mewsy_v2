...
export const LANGUAGES: Language[] = [
  ...
  { code: 'es',    flag: '🇪🇸', label: 'Español',            systemName: 'Spanish' },
];

// Maps Mewsy language codes → BCP 47 locale tags for the Web Speech API
...
export const UI_STRINGS: Record<string, Record<string, string>> = {
  // ── Chat bubbles / input ──────────────────────────────────────────────────
  somethingElse:  { en: 'Something else',                  de: 'Etwas anderes',                        'de-ch': 'Etwas anderes',                        'de-at': 'Etwas anderes',                        fr: 'Autre chose',                            nl: 'Iets anders',                          es: 'Otra cosa'                            },
  typeOwn:        { en: 'Or type your own answer...',      de: 'Oder eigene Antwort eingeben...',       'de-ch': 'Oder eigene Antwort eingeben...',       'de-at': 'Oder eigene Antwort eingeben...',       fr: 'Ou tapez votre propre réponse...',       nl: 'Of typ uw eigen antwoord...',          es: 'O escribe tu propia respuesta...'     },
  typeMsg:        { en: 'Type your message...',            de: 'Nachricht eingeben...',                 'de-ch': 'Nachricht eingeben...',                 'de-at': 'Nachricht eingeben...',                 fr: 'Tapez votre message...',                 nl: 'Typ uw bericht...',                    es: 'Escribe tu mensaje...'                },
  scrollLatest:   { en: 'Latest',                         de: 'Neueste',                               'de-ch': 'Neueste',                               'de-at': 'Neueste',                               fr: 'Dernier',                                nl: 'Nieuwste',                             es: 'Más reciente'                         },

  // ── Sidebar nav ───────────────────────────────────────────────────────────
  newChat:        { en: 'New chat',                        de: 'Neuer Chat',                            'de-ch': 'Neuer Chat',                            'de-at': 'Neuer Chat',                            fr: 'Nouvelle conversation',                  nl: 'Nieuw gesprek',                        es: 'Nuevo chat'                           },
  search:         { en: 'Search',                          de: 'Suchen',                                'de-ch': 'Suchen',                                'de-at': 'Suchen',                                fr: 'Rechercher',                             nl: 'Zoeken',                               es: 'Buscar'                               },
  helpResources:  { en: 'Help & Resources',                de: 'Hilfe & Ressourcen',                    'de-ch': 'Hilfe & Ressourcen',                    'de-at': 'Hilfe & Ressourcen',                    fr: 'Aide & Ressources',                      nl: 'Hulp & Bronnen',                       es: 'Ayuda y recursos'                     },
  chats:          { en: 'Chats',                           de: 'Chats',                                 'de-ch': 'Chats',                                 'de-at': 'Chats',                                 fr: 'Conversations',                          nl: 'Gesprekken',                           es: 'Chats'                                },
  settings:       { en: 'Settings',                        de: 'Einstellungen',                         'de-ch': 'Einstellungen',                         'de-at': 'Einstellungen',                         fr: 'Paramètres',                             nl: 'Instellingen',                         es: 'Configuración'                        },

  // ── Top bar ───────────────────────────────────────────────────────────────
  openSidebar:    { en: 'Open sidebar',                    de: 'Seitenleiste öffnen',                   'de-ch': 'Seitenleiste öffnen',                   'de-at': 'Seitenleiste öffnen',                   fr: 'Ouvrir le panneau',                      nl: 'Zijbalk openen',                       es: 'Abrir barra lateral'                  },
  expandFullscreen:{ en: 'Expand to fullscreen',           de: 'Vollbild',                              'de-ch': 'Vollbild',                              'de-at': 'Vollbild',                              fr: 'Plein écran',                            nl: 'Volledig scherm',                      es: 'Pantalla completa'                    },
  shrinkToPanel:  { en: 'Shrink to side panel',            de: 'Seitenansicht',                         'de-ch': 'Seitenansicht',                         'de-at': 'Seitenansicht',                         fr: 'Réduire en panneau',                     nl: 'Zijpaneel',                            es: 'Panel lateral'                        },

  // ── Hero section ──────────────────────────────────────────────────────────
  heroHeadlinePre:  { en: 'How can I ',                    de: 'Wie kann ich Ihnen heute ',             'de-ch': 'Wie kann ich Ihnen heute ',             'de-at': 'Wie kann ich Ihnen heute ',             fr: 'Comment puis-je vous ',                  nl: 'Hoe kan ik u vandaag ',                es: '¿Cómo puedo '                        },
  heroHighlight:    { en: 'help',                          de: 'helfen',                                'de-ch': 'helfen',                                'de-at': 'helfen',                                fr: 'aider',                                  nl: 'helpen',                               es: 'ayudarte'                             },
  heroHeadlinePost: { en: ' you today?',                   de: '?',                                     'de-ch': '?',                                     'de-at': '?',                                     fr: '\u00a0aujourd\u2019hui\u00a0?',           nl: '?',                                    es: ' hoy?'                                },

  // ── Quick action buttons ──────────────────────────────────────────────────
  qaOnboarding:   { en: 'Onboarding help',                 de: 'Onboarding-Hilfe',                      'de-ch': 'Onboarding-Hilfe',                      'de-at': 'Onboarding-Hilfe',                      fr: "Aide à l\u2019intégration",              nl: 'Onboarding hulp',                      es: 'Ayuda con onboarding'                 },
  qaSearchDocs:   { en: 'Search the docs',                 de: 'Dokumentation durchsuchen',             'de-ch': 'Dokumentation durchsuchen',             'de-at': 'Dokumentation durchsuchen',             fr: 'Rechercher dans la doc',                 nl: 'Documentatie doorzoeken',              es: 'Buscar en la documentación'           },
  qaConfigureMapping:{ en: 'Configure mapping',            de: 'Mapping konfigurieren',                 'de-ch': 'Mapping konfigurieren',                 'de-at': 'Mapping konfigurieren',                 fr: 'Configurer le mapping',                  nl: 'Mapping instellen',                    es: 'Configurar mapping'                   },
  qaTroubleshoot: { en: 'Troubleshoot issue',              de: 'Problem beheben',                       'de-ch': 'Problem beheben',                       'de-at': 'Problem beheben',                       fr: 'Résoudre un problème',                   nl: 'Probleem oplossen',                    es: 'Resolver un problema'                 },
  qaBilling:      { en: 'Billing & plans',                 de: 'Abrechnung & Pläne',                    'de-ch': 'Abrechnung & Pläne',                    'de-at': 'Abrechnung & Pläne',                    fr: 'Facturation & abonnements',              nl: 'Facturering & plannen',                es: 'Facturación y planes'                 },
...
export const welcomeText: Record<string, string[]> = {
  ...
  es: [
    "¡Hola! Soy Mewsie, el asistente de soporte de Mews x Omniboost.",
    "Ya sea que estés en proceso de onboarding, configurando tu mapping o solucionando un problema, estoy aquí para ayudarte. ¿Qué necesitas?"
  ],
};
...
export const thinkingMessagesMap: Record<string, string[]> = {
  ...
  es:    ["Mewsie está pensando...", "Consultando la documentación...", "Casi listo...", "Un momento más..."],
};
